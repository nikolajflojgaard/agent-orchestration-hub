...
description: Coordinate multiple agents when a task benefits from parallel research, implementation, review, testing, monitoring, or release work; use for subagent briefs, role assignment, run-state tracking, ownership boundaries, merge gates, cleanup, and final synthesis.
---
